...
Source0  : https://files.pythonhosted.org/packages/57/83/06ecd1d52c506d3f6aa4a43ba84ab8d4218bf5bf03656ac9a93be357e72e/scrypt-0.8.24.tar.gz
...
%prep
%setup -q -n scrypt-0.8.24
cd %{_builddir}/scrypt-0.8.24
pushd ..
cp -a scrypt-0.8.24 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709325977
